...
sed -i -E "s/(tensor_para_size=)[0-9]+/\12/" "$CONFIG_FILE"
sed -i -E "s#(model_dir\s*=\s*).*#\1/mnt/models/opt-13b/spinfer-model/2-gpu#" "$CONFIG_FILE"

# Define the output directory path
OUTPUT_DIR="${SpInfer_HOME}/third_party/FasterTransformer/Result_13B/2-gpu"
...
sed -i -E "s#(model_dir\s*=\s*).*#\1/mnt/models/opt-30b/spinfer-model/2-gpu#" "$CONFIG_FILE"

# Define the output directory path
OUTPUT_DIR="${SpInfer_HOME}/third_party/FasterTransformer/Result_30B/2-gpu"
